<form id="SearchFormElement" name="SearchForm"
      action="/search-listings/l/Search.form" method="POST"
	...
	padding-top: 10px; margin-top: 0px; text-align: center;*/">
            ...
            <div style="text-align: left">
                ...
                <fieldset id="selectedFields" style="/*clear: both; margin-top: 10px;*/">
                    <!--<legend class="large-legend">Find listings:</legend>-->
                    ...
                    <div class="control-holder" style="display:none;">
                        <div id="PROPERTY_TYPE">
                            <!--<div class="large-label">Property Type:</div>-->
                            <select class="large-control" name="values[PROPERTY_TYPE]" style="/*width: 280px*/">
                                <option value=""></option>
                                <option selected value="COMM"
                                    >Commercial</option>
                                <option value="FARM"
                                    >Farm</option>
                                <option value="MULT"
                                ...
                                <option value="RESI"
                                    >Residential</option>
                                <option value="RESIACREAGE"
                                    >Residential Acreage</option>
                                <option value="RESICONDO"
                                    >Residential Condo</option>
                                <option value="RESIMOBILE"
                                    >Residential Mobile</option>
                            </select>
                        </div>
                    </div>
                    <div class="control-holder">
    ...
    <div class="additional-search-controls" style="text-align: right; display: none;">
        Listed:
    ...
    <div class="mrp-search-form-buttons-container" style="padding: 0px 0px 30px 0px; text-align: right;">
        <input type="submit" id="finishSearchButton" name="finishSearch"  class="form-button-large"
               value="Search" style="margin-left: 10px; width: 120px; font-weight: bold;">
    </div>
